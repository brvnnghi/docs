...
Đây là pattern [**Intercepting Route**](/next-js/intercepting-routes) — một trong những tính năng nâng cao của Next.js App Router. Và hook đứng sau hầu hết những thao tác điều hướng kiểu này là `useRouter` từ `next/navigation`.
